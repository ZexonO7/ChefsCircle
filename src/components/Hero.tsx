          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              ...
              <motion.div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center" variants={itemVariants}>
                ...
                <button onClick={scrollToContact} className="chef-button-secondary flex items-center justify-center group text-lg">
                  Get Started
                  <ChefHat className="ml-2 w-5 h-5 group-hover:scale-110 transition-transform" />
                </button>
              </motion.div>
              
              <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-8 text-chef-warm-ivory/80" variants={itemVariants}>
                <div className="flex items-center gap-2">
                  <Users className="w-5 h-5" />
                  <span className="text-sm">100+ Active Members</span>
                </div>
