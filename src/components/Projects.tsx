  ...
  const membershipTiers = [
    {
      ...
      features: [
        "2 live cook-alongs per month",
        "Access to basic technique library",
        "Community forum access",
        "Monthly recipe collection",
        "Email support"
      ],
    ...
    },
    {
      ...
      features: [
        "Unlimited live cook-alongs",
        "Exclusive chef-led workshops",
        "Personal culinary coaching",
        "VIP event invitations",
        "Custom meal planning",
        "Premium ingredient boxes",
        "24/7 chef hotline"
      ],
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <CardContent className="p-8">
                  ...
                  <ul className="space-y-3 mb-8">
                    {tier.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center text-chef-charcoal/80 font-inter">
                  ...
                  <Button 
                    ...
                    className={`w-full chef-button-${tier.color === 'chef-gold' ? 'gold' : tier.color === 'chef-royal-blue' ? 'secondary' : 'primary'}`}
                  >
                    Start Cooking
                  </Button>
                </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {upcomingEvents.map((event, index) => (
            <Card key={index} className="chef-card chef-hover-lift overflow-hidden">
              <div className="relative h-48">
                ...
                <div className="absolute top-4 right-4">
                  <span className={`px-2 py-1 rounded text-xs font-medium ${
                    event.level === 'Beginner' ? 'bg-chef-royal-green text-white' :
                    event.level === 'Intermediate' ? 'bg-chef-royal-blue text-white' :
