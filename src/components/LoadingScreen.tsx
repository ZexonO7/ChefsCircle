...
const LoadingScreen = () => {
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-chef-charcoal via-chef-royal-green to-chef-royal-blue flex items-center justify-center">
      <div className="text-center">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl font-bold font-playfair text-chef-warm-ivory mb-4"
        >
          ChefCircle
        </motion.h1>
        ...
        >
          {[...Array(3)].map((_, i) => (
            <motion.div
              key={i}
              className="w-2 h-2 bg-chef-warm-ivory rounded-full"
              animate={{
                scale: [1, 1.5, 1],
                opacity: [0.5, 1, 0.5]
              }}
