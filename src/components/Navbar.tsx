...
const Navbar = () => {
  ...
  return (
    <motion.nav 
      className="fixed top-0 w-full bg-chef-warm-ivory/95 backdrop-blur-sm z-50 border-b border-chef-royal-blue/10"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
        ...
        <div className="flex justify-between items-center h-20">
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 ${
                    isActive(item.href)
                      ? "text-chef-royal-blue bg-chef-royal-blue/10"
                      : "text-chef-charcoal hover:text-chef-royal-blue hover:bg-chef-royal-blue/5"
                  }`}
                >
                  {item.name}
                </Link>
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-chef-charcoal hover:text-chef-royal-blue p-2"
            >
      ...
      {isOpen && (
        <motion.div
          className="md:hidden bg-chef-warm-ivory border-t border-chef-royal-blue/10"
