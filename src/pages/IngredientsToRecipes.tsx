            ...
            <Card className="bg-white/80 backdrop-blur-sm border-chef-royal-green/20 shadow-lg">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex gap-3">
                  <Input value={currentIngredient} onChange={e => setCurrentIngredient(e.target.value)} onKeyPress={handleKeyPress} placeholder="e.g., chicken breast, tomatoes, garlic..." className="flex-1 border-chef-royal-green/30 focus:border-chef-royal-green bg-[chef-warm-ivory] bg-chef-navy" />
