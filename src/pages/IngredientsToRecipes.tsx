...
const IngredientsToRecipes = () => {
  ...
  const generateRecipes = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('generate-recipes-from-ingredients', {
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex gap-3">
                  <Input
                    ...
                    className="flex-1 border-chef-royal-green/30 focus:border-chef-royal-green"
                  />
                  <Button 
