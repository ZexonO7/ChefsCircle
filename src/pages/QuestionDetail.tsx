...
const QuestionDetail = () => {
        ...
        <div className="min-h-screen bg-chef-warm-ivory pt-20">
          <div className="chef-container py-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <button onClick={() => navigate('/library')} className="chef-button-primary">
  ...
  return <PageLayout>
      <SEO title={`${question.title} - ChefsCircle Community`} description={question.content} keywords={['cooking question', 'culinary help', 'chef advice', question.category.toLowerCase()]} />
      
      <div className="min-h-screen bg-chef-warm-ivory pt-20">
        <div className="chef-container py-8">
          <button onClick={() => navigate('/library')} className="flex items-center gap-2 text-chef-royal-blue hover:text-chef-charcoal transition-colors mb-6">
          ...
          <div className="max-w-4xl mx-auto">
            {/* Question */}
            <motion.div className="chef-card p-8 mb-8" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
              ...
              <div className="flex items-start gap-4 mb-6">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    {question.has_accepted_answer && <span className="chef-badge-green text-sm">
                        ✓ Answered
                      </span>}
                  </div>
            ...
            <div className="mb-8">
                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          {answer.is_accepted && <span className="chef-badge-green text-xs">
              ...
              {answers.length === 0 && <div className="text-center py-8">
            ...
            {/* Answer Form */}
            <motion.div className="chef-card p-6" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
