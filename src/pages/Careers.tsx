...
const Careers = () => {
  ...
  return <div className="min-h-screen bg-chef-warm-ivory">
      <PageLayout showContact={false}>
        <SEO title="Join Our Culinary Team - ChefsCircle Careers" description="Join ChefsCircle's passionate team of culinary educators and food enthusiasts. We're looking for talented individuals to help revolutionize culinary education." imageUrl="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" keywords={['culinary careers', 'chef jobs', 'cooking instructor', 'culinary education', 'food industry careers']} />
          ...
          <div className="container mx-auto">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                duration: 0.5,
                delay: 0.3
              }} className="text-xl text-chef-charcoal/70 mb-12 font-inter">We welcome both full-time management professionals and interns for roles like Social Media Managers, Web Developers, and SPO managers who are eager to contribute to the future of culinary education.</motion.p>
                ...
                duration: 0.6
                  ...
                  }].map((benefit, i) => <div key={i} className="chef-card p-6 h-full chef-hover-lift">
                  ...
                  <div className="chef-card p-8 shadow-chef-luxury mt-12">
                    ...
                    <div className="chef-card bg-chef-warm-ivory p-6 border border-chef-royal-green/20">
                      <div className="flex flex-col items-center text-center">
                        <img src="/lovable-uploads/6ee4e578-88a2-4aed-b6ff-ac4750539739.png" alt="Advithya Bhardwaj" className="w-32 h-32 rounded-full mb-4 object-cover" style={{
                        ...
                        <div className="flex flex-col space-y-3">
                          ...
                          <a href="https://www.linkedin.com/in/advithya-bhardwaj-05412a313/" target="_blank" rel="noopener noreferrer" className="flex items-center text-chef-charcoal hover:text-chef-royal-blue transition-colors">
